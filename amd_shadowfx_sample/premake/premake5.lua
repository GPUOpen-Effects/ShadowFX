...
project (_AMD_LIBRARY_NAME .. "_Sample")
   ...
   includedirs { "../src/ResourceFiles", "../../AMD_%{_AMD_LIBRARY_NAME}/inc", "../../amd_lib/shared/d3d11/inc", "../../framework/d3d11/amd_sdk/inc", "../../amd_lib/ags_lib/inc", "../../framework/d3d11/dxut/Core", "../../framework/d3d11/dxut/Optional" }
