...
workspace (_AMD_LIBRARY_NAME .. "_CrossfireAPI_Sample")
   configurations { "Debug", "Release" }
   platforms { "x64" }
   location "../build"
   filename (_AMD_LIBRARY_NAME .. "_CrossfireAPI_Sample" .. _AMD_VS_SUFFIX)
   startproject (_AMD_LIBRARY_NAME .. "_CrossfireAPI_Sample")
...
project (_AMD_LIBRARY_NAME .. "_CrossfireAPI_Sample")
   kind "WindowedApp"
   language "C++"
   location "../build"
   filename (_AMD_LIBRARY_NAME .. "_CrossfireAPI_Sample" .. _AMD_VS_SUFFIX)
   ...
   includedirs { "../src/ResourceFiles", "../src/inc", "../../AMD_%{_AMD_LIBRARY_NAME}/inc", "../../AMD_LIB/inc", "../../AMD_SDK/inc", "../../AGS_LIB/inc", "../../DXUT/Core", "../../DXUT/Optional" }
   libdirs { "../../AGS_LIB/lib" }
